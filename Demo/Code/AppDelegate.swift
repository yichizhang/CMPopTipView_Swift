...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if let window = window {
            ...
            vc1.tabBarItem = UITabBarItem(title: "Buttons", image: DemoStyleKit.imageOfOne, tag: 0)
            
            let vc2 = DemoTableViewController()
            vc2.tabBarItem = UITabBarItem(title: "Table View", image: DemoStyleKit.imageOfTwo, tag: 0)
